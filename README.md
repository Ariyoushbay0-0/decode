...
این ابزار برای اهداف آموزشی و مسابقات CTF طراحی شده است.

از آن فقط روی فایل‌ها و داده‌هایی استفاده کنید که اجازه تحلیل آن‌ها را دارید.

---
CTF • Cyber Security • Python
```
